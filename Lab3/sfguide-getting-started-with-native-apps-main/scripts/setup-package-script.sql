...
create or replace view MFG_SHIPPING as select * from NATIVE_APP_QUICKSTART_WH.NATIVE_APP_QUICKSTART_DB.NATIVE_APP_QUICKSTART_SCHEMA.MFG_SHIPPING;

grant usage on schema shared_content_schema to share in application package {{ package_name }};
grant reference_usage on database NATIVE_APP_QUICKSTART_WH.NATIVE_APP_QUICKSTART_DB to share in application package {{ package_name }};
